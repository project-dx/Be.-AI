...
| 月次利用者分析レポート機能（2026-07-22追加） | ✅ 完了（スタッフ/管理者メニュー「月次レポート」） |
| ウェルビーイングカード機能（2026-07-22追加） | ✅ 完了（利用者メニュー「カードをえらぶ」・32種から3枚選択） |
| 初期アセスメント（生育歴・障害特性・思考特性/ハーマンモデル・価値観） | ✅ 完了（利用者詳細「アセスメント」タブ） |
| バイタルデータ（体温・血圧・脈拍） | ✅ 完了（日報の「こころ・からだ」ステップで任意入力） |
| カラフルピラミッド（ミッション/ビジョン/パッション/ウェルビーイング） | ✅ 完了（利用者メニュー「わたしのピラミッド」／スタッフはアセスメントタブ） |
| 6か月ごとのモニタリング評価 | ✅ 完了（利用者詳細「モニタリング」タブ・下書き自動生成→スタッフ編集） |
